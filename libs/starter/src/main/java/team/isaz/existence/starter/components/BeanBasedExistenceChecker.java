...
public class BeanBasedExistenceChecker implements ExistenceChecker {
    ...
    /**
     * Constructs the checker using beans from the Spring context that was described in properties
     * @param props properties that contain names of injecting beans
     * @param ruleBeans all {@link AbsenceRule} beans with their names
     * @param strategies all {@link AbsenceInterpretationStrategy} beans with their names
     */
    @Autowired
